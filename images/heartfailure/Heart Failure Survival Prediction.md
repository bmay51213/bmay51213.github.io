...
```
    ...
    <ipython-input-12-384d7f5bdef4> in <module>
          8 a = a.ravel()
          9 for idx, ax in enumerate(a):
    ---> 10     ax.hist(df_num.iloc[:,idx], bins = 150)
         11     ax.set_title(df_num.columns[idx], size = 40)
         12     ax.set_ylabel('Counts', size = 20)
    

    ~\Anaconda\lib\site-packages\pandas\core\indexing.py in __getitem__(self, key)
    ...
    ~\Anaconda\lib\site-packages\pandas\core\indexing.py in _getitem_tuple(self, tup)
    ...
    ~\Anaconda\lib\site-packages\pandas\core\indexing.py in _has_valid_tuple(self, key)
    ...
    ~\Anaconda\lib\site-packages\pandas\core\indexing.py in _validate_key(self, key, axis)
       1992             return
    ...
    ~\Anaconda\lib\site-packages\pandas\core\indexing.py in _validate_integer(self, key, axis)
...
![png](output_28_0.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x145ab1b0e80>
...
![png](output_36_2.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x145a9b8f970>
...
![png](output_37_0.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x145a9c5d310>
...
![png](output_40_2.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x145adafefa0>
...
![png](output_41_0.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x145ada11250>
...
![png](output_44_2.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x145baabf310>
...
![png](output_45_0.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x145aad585e0>
